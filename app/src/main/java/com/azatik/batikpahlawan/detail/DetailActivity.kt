...
class DetailActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (modelMain != null) {
            ...
            tvAsal.setText(asal)
            tvUsia.setText(usia)
            tvLahir.setText("Tutorial Video Batik : $lahir")
            tvWafat.setText("Rincian : $gugur")
            tvMakam.setText("Deskripsi : $lokasimakam")
            tvRiwayat.setText("Capstone Project : $history")
        }
    }
