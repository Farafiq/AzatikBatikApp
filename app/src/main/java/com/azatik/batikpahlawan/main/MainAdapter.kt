...
import com.azatik.batikpahlawan.main.MainAdapter.MainViewHolder
...
class MainAdapter(
    var context: Context,
    var modelMainList: MutableList<ModelMain>,
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MainViewHolder {
        val view =
            LayoutInflater.from(parent.context).inflate(R.layout.list_nama_pahlawan, parent, false)
